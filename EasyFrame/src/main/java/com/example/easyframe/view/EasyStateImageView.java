 ...
 */
public class EasyStateImageView extends AppCompatImageView {
    ...
    public EasyStateImageView(Context context) {
        this(context, null);
    }

    public EasyStateImageView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EasyStateImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
