 ...
 */
public class EasyStateLinView extends LinearLayout {
    ...
    public EasyStateLinView(Context context) {
        this(context, null);
    }

    public EasyStateLinView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EasyStateLinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
